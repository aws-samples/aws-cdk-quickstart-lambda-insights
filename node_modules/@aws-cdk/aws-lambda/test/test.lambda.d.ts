...
declare const _default: {
    ...
    'imported Function w/ resolved account and function arn can addPermissions'(test: Test): void;
    'imported Function w/o account cannot addPermissions'(test: Test): void;
